...
(define (future/c raw-arg)
  (let* ((arg (car (coerce-contracts 'future/c (list raw-arg))))
         (pred (flat-contract-predicate arg)))
    (make-future-flat/c pred arg)))
    
(define-struct future-flat/c (pred flat-ctc)
  #:property proj-prop future-flat-proj
  #:property name-prop
  (λ (ctc)
    (apply build-compound-type-name 
           'future/c 
           (list (future-flat/c-flat-ctc ctc))))
   #:property flat-prop
   (λ (ctc)
     (future-flat/c-pred ctc))      
  #:property stronger-prop
  (λ (this that)
    (and (future-flat/c? that)
         (let ([this-ctc (future-flat/c-flat-ctc this)]
               [that-ctc (future-flat/c-flat-ctc that)])
