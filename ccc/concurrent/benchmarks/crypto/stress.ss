...
(module server scheme
  ...
  (provide/contract
   [reorder (->d ((s (future/c (listof any/c)))
                  (i (future/c (and/c (listof natural-number/c)
                                 (curry andmap (curry > (length s)))))))
                 ()
                 (r (future/c (and/c (listof any/c)
...
(module client scheme
  ...
  (require (only-in "../../contract.ss" future/c))
...
(module stress scheme
  ...
  (require (only-in "../../contract.ss" master-start))
